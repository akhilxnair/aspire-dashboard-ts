...
const Sidebar = () => {
  ...
  return (
    <aside className="w-[50px] md:w-[340px] bg-[#0C365A] flex flex-col transition-all duration-300 pt-12">
      <div className="w-65  flex-col gap-5 mb-20 mx-auto hidden md:flex">
        <AspireLogo className="w-32 h-9 hidden md:block" />
      ...
      <nav className="flex flex-col gap-15 w-10 md:w-65 mx-auto">
        {menuItems.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.href}
              className={cn(
                "flex items-center gap-4 text-base font-medium transition-colors justify-center md:justify-start",
